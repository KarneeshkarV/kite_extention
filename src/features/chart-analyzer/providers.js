(function () {
  ...
  ns.chartAnalyzer.providers = [
    { id: 'claude',  label: 'Claude',  model: 'claude-sonnet-4-5', supportsVision: true  },
    { id: 'gemini',  label: 'Gemini',  model: 'gemini-3-pro',      fallbackModels: ['gemini-3-flash-thinking'], supportsVision: true  },
    { id: 'chatgpt', label: 'ChatGPT', model: 'gpt-5.4',           fallbackModels: ['gpt-5'],          supportsVision: false },
    { id: 'grok',    label: 'Grok',    model: 'grok-4',            supportsVision: false },
  ];
